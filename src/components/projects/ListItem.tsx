  ...
  return (
    <Link href={{
      ...
      <a className='block py-5 mobile:py-8 laptop:grid grid-cols-2'>
        ...
        />
        <div className='stripes bg-darkerGrey laptop:bg-black pt-5 mobile:pt-8 laptop:text-right laptop:p-0  '>
          ...
          <div className="bg-fullPink text-black p-4 font-bold text-center mt-8 mobile:mt-12 rounded-sm text-xl laptop:inline-block laptop:bg-mutedPink laptop:hover:bg-fullPink ">
            Find out more
          </div>
        </div>
      </a>
