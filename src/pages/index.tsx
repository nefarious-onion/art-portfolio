  ...
  return (
    <HomeLayout siteData={siteData}>
      ...
      <div className="laptop:pl-12 h-full laptop:pt-12 font-alternate laptop:text-3xl">
        <div className='text-fullMint laptop:ml-12 pl-8 py-2 text-2xl tablet:text-3xl font-bold absolute top-28 tablet:top-44 left-0 bg-black bg-opacity-50 w-full laptop:w-1/4'>
          <p>{pageTexts.hero.hero1}</p>
          <p>{pageTexts.hero.hero2}</p>
          <p>{pageTexts.hero.hero3}</p>
        </div>
        <div className='text-white w-full tablet:text-2xl pl-8 py-2 text-right pr-8 laptop:ml-12 absolute bottom-20 laptop:bottom-52 right-0 bg-black bg-opacity-50 laptop:left-0 laptop:text-left laptop:w-1/4 '>
